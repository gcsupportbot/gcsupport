package github.gcsupportbot.gcsupport;

import github.gcsupportbot.gcsupport.listeners.DiscordSetupListener;
import github.gcsupportbot.gcsupport.listeners.DiscordSupportTicketCloseListener;
import github.gcsupportbot.gcsupportt.listeners.DiscordSupportTicketCreationListener;
    ...
    public DiscordSupportBot(String botToken) {
        ...
        try {
            jda = new JDABuilder(AccountType.BOT)
                    ...
                    .setGame(Game.of("GoliCraft Support"))
                    .setToken(botToken)
                    .buildBlocking();
